...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        intent.setComponent(new ComponentName(this, WFwidget.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(), "AIzaSyCuZ00dcqmK-V-DJUYXl4pfN72wYQdBTkA");
